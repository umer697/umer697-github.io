    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="email" name="email" placeholder="E.g. hi@umer.com" class="input-responsive" required>
...
// echo $sql2; die();
    ...
    if($res2 == true)
    {
        $_SESSION['order'] ="<div class='session-msg'>Your Order has been Placed Successfully.</div>";
        header('location:' .SITEURL);
    }
    else
    {
    $_SESSION['order'] = "<div class='session-error'>Faild to Place the Order Please Try Again.</div>";
    header('location:' .SITEURL);
    }
}
else
