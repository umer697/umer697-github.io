...
<?php
        //message for providing wrong category id  in url manually by the user.
    if(isset($_SESSION['cat-id-not-found']))
    {
        echo $_SESSION['cat-id-not-found'];
        unset($_SESSION['cat-id-not-found']);
    }
    //message for providing wrong food id in url manually by the user.
    if(isset($_SESSION['food-id-not-found']))
    {
        echo $_SESSION['food-id-not-found'];
        unset($_SESSION['food-id-not-found']);
    }
     //message for order placing
...
<section class="categories">
    <div class="container">
        ...
        {
        //
        echo "<div class='session-error'>Category Image  not Added.</div>";
        }
        ?>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php
            ...
            {
            echo "<div class='session-error'>No Food Found.</div>";
            }
